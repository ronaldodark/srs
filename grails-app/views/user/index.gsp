		...
		<div id="list-user" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="institutionalMail" title="${message(code: 'user.institutionalMail.label', default: 'Institutional Mail')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "institutionalMail")}</td>
